...
(function(plupload){
    ...
    plupload.runtimes.Signiant = plupload.addRuntime('signiant', {
       ...
       init: function(uploader, callback){
            ...
            }, uploader.settings.signiant_path + 'getJavaInfo.jar');
       },
       loadApplet: function(uploader){
    ...
    tmpl = (function(){
        ...
        return function(up){
            ...
            if(window.ActiveXObject){
                html = '<object classid="clsid:8AD9C840-044E-11D1-B3E9-00805F499D93" id="SigniantApplet_' + up.id + '" name="SigniantApplet_' + up.id + '" width="0" height="0" codebase="https://java.sun.com/update/1.5.0/jinstall-1_5_0_03-windowsi586.cab#Version=1,5,0,0">';
            }else{
    ...
    // Java detection
    /* PluginDetect v0.7.5 by Eric Gerds www.pinlady.net/PluginDetect [ onWindowLoaded isMinVersion getVersion onDetectionDone Java(OTF & NOTF) ] */
    PluginDetect={version:"0.7.5",name:"PluginDetect",handler:function(c,b,a){return function(){c(b,a)}
